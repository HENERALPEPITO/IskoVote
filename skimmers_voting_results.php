...
<div class="container-center-horizontal">
    <div class="votingResults">
        ...
        <div class="content">
            <div class="dash">
                <a href="skimmers_settings.php">  <input id="dashItem" type="submit" value="Election Settings"></a>
                <a href="skimmers_candidates.php"><input id="dashItem" type="submit" value="Candidates"></a>
