...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO redbolts_settings (description, duration_from, duration_to) VALUES (?, ?, ?)");
    ...
    // Redirect to redbolts_settings.html
    header("Location: redbolts_candidates.php");
    exit;
}
?>
...
<head>
  ...
  <link href="redbolts.css" rel="stylesheet" />
      ...
      electionForm.addEventListener('submit', (event) => {
        ...
        fetch('<?php echo $_SERVER['PHP_SELF']; ?>', {
          ...
          .then(data => {
            ...
            // Redirect to redbolts_candidates.php
            location.replace("redbolts_candidates.php");
