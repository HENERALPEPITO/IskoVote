...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO skimmers_settings (description, duration_from, duration_to) VALUES (?, ?, ?)");
    ...
    // Redirect to skimmers_settings.html
    header("Location: skimmers_candidates.php");
    exit;
}
?>
...
<head>
  ...
  <link href="skimmers.css" rel="stylesheet" />
      ...
      electionForm.addEventListener('submit', (event) => {
        ...
        fetch('<?php echo $_SERVER['PHP_SELF']; ?>', {
          ...
          .then(data => {
            ...
            // Redirect to skimmers_candidates.php
            location.replace("skimmers_candidates.php");
