...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO clovers_settings (description, duration_from, duration_to) VALUES (?, ?, ?)");
    ...
    // Redirect to clovers_settings.html
    header("Location: clovers_candidates.php");
    exit;
}
?>
...
<head>
  ...
  <link href="clovers.css" rel="stylesheet" />
      ...
      electionForm.addEventListener('submit', (event) => {
        ...
        fetch('<?php echo $_SERVER['PHP_SELF']; ?>', {
          ...
          .then(data => {
            ...
            // Redirect to clovers_candidates.php
            location.replace("clovers_candidates.php");
