...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="elektrons_homepage.css" />
    ...
    <div class="votingResults">
        ...
        <div class="content">
            <div class="sidebar">
                ...
                <script>
                    function Candidates() {
                        location.replace("elektrons_homepage.php");
                    }
                    function ViewScores() {
                        location.replace("elektrons_voting_results.php");
                    }
                </script>
            </div>
            <div class="results">
                <div class="resultExit">
                    <a href="elektrons_homepage.php" id="return">Return to Elections</a>
                </div>
                <div class="scores">
